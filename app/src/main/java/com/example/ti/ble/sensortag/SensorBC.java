...
*/
/**
 * Created by sethu_000 on 5/5/2015.
 *//*
...
public class SensorBC extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        client.post("http://localhost:80/mysqlsqlitesync/getdbrowcount.php",params ,new AsyncHttpResponseHandler() {
            @Override
